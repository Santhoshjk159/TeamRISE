...
│                                                             │
│  ┌──────────┐  ┌──────────────┐  ┌────────────────────┐    │
│  │ Predictive│  │ Optimization │  │ Energy Intelligence│    │
│  │  Layer    │  │   Engine     │  │     Engine         │    │
│  │ ─────────│  │ ─────────── │  │ ──────────────────│    │
│  │ XGB+RF   │  │ NSGA-II     │  │ FFT Spectral      │    │
│  │ Physics  │  │ Bayesian    │  │ Pattern Cluster   │    │
│  │ Hybrid   │  │ RL Q-Learn  │  │ Drift Detection   │    │
│  │ SHAP     │  │ Pareto      │  │ Reliability Score │    │
│  └──────────┘  └──────────────┘  └────────────────────┘    │
│                                                             │
│  ┌──────────────┐  ┌────────────┐  ┌──────────────────┐    │
│  │   Golden      │  │  Carbon    │  │  Decision Engine │    │
│  │  Signature    │  │  Target    │  │                  │    │
│  │ ────────────│  │ ──────────│  │ ────────────────│    │
│  │ Self-improve │  │ Dynamic   │  │ RT Monitoring   │    │
│  │ HITL Approve │  │ Grid-aware│  │ Deviation Detect│    │
│  │ Versioned   │  │ Optimal   │  │ Root Cause      │    │
│  │             │  │ Windows   │  │ Corrections     │    │
│  └──────────────┘  └────────────┘  └──────────────────┘    │
│                                                             │
│  ┌──────────────────────┐  ┌───────────────────────────┐   │
│  │    Digital Twin       │  │   Validation & ROI        │   │
│  │ ────────────────────│  │ ─────────────────────────│   │
│  │ Process Simulator    │  │ Historical Replay         │   │
│  │ Energy Simulator     │  │ A/B Testing              │   │
│  │ What-If Analysis     │  │ Cross Validation         │   │
│  │ Maintenance Forecast │  │ ROI Calculator (NPV)     │   │
│  └──────────────────────┘  └───────────────────────────┘   │
│                                                             │
├─────────────────────────────────────────────────────────────┤
│                    Data Layer                                │
│  Ingestion → Preprocessing → Feature Engineering → DB       │
│  (Excel/CSV, KNN imputation, Z-score outliers, FFT,        │
│   rolling stats, phase aggregation, energy features)        │
└─────────────────────────────────────────────────────────────┘
```
